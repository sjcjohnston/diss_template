...
\end{figure}
%
Linear regression models were fit onto the data, with a slope of $\Sexpr{coef(mod_m)[2]}$ for the mouth-recorded data, and a slope of $\Sexpr{coef(mod)[2]}$ for the ear-recorded data.
