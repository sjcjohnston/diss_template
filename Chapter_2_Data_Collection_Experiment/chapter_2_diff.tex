...
%DIF < \begin{figure}
%DIFDELCMD < \centering
%DIFDELCMD <   \includegraphics[width=0.5\textwidth]{figure/bekesy60-3b.png}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF >  %\begin{figure}
%DIF >  \centering
%DIF >    \includegraphics[width=0.5\textwidth]{figure/bekesy60-3b.png}
...
%DIFDELCMD < \centering
%DIFDELCMD <   \includegraphics{figure/open-closed-tube.png}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[h!]
%DIFDELCMD < \includegraphics[width=1\textwidth]{figure/BCrelAC_e_s.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF >  \includegraphics[width=1\textwidth]{figure/BCrelAC_e_s.png}
...
%DIFDELCMD < %%%
%DIF <  \begin{figure}
%DIFDELCMD < \includegraphics[width=0.45\textwidth]{figure/BC_rel_AC_all.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFdelend %DIF >  \begin{wrapfigure}{l!}{0.5\textwidth}
%DIF >  % \begin{figure}
%DIF >  \includegraphics[width=0.45\textwidth]{figure/BC_rel_AC_all.png}
...
%DIFDELCMD < \includegraphics[width=0.5\textwidth]{figure/bekesy60-3.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF >  \includegraphics[width=0.5\textwidth]{figure/bekesy60-3.png}
...
%
\DIFdelbegin %DIFDELCMD < \begin{wrapfigure}{r!}{0.5\textwidth}
%DIFDELCMD < \includegraphics[width=0.5\textwidth]{figure/bekesy60-1.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF >  \includegraphics[width=0.5\textwidth]{figure/bekesy60-1.png}
...
%DIF >    \centering
%DIF >    \includegraphics[width=0.8\textwidth]{figure/hansenAverageOE.png}
%DIF >    \caption{ }
...
%DIF >      \centering
%DIF >      \includegraphics[width=1\textwidth]{figure/Hansen_OE-plot_a.png}
%DIF >    \end{subfigure}
%DIF >    \begin{subfigure}{0.8\textwidth}
%DIF >      \centering
%DIF >      \includegraphics[width=1\textwidth]{figure/Hansen_OE-plot_b.png}
%DIF >    \end{subfigure}
%DIF >    \caption{ }
