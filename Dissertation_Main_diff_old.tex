...
%DIF DEL Dissertation_Main_old.tex   Wed Jul 26 23:05:27 2017
%DIF ADD Dissertation_Main.tex       Tue Aug  1 22:37:08 2017
%            for use with the              %
...
\usetikzlibrary{decorations.pathmorphing} % noisy shapes %DIF > 
\usetikzlibrary{fit}					% fitting shapes to coordinates %DIF > 
\usetikzlibrary{backgrounds}	% drawing the background after the foreground %DIF > 
 %DIF > 
					 %DIF > 
					 %DIF > 
%DIF PREAMBLE EXTENSION ADDED BY LATEXDIFF %DIF > 
%DIF UNDERLINE PREAMBLE %DIF PREAMBLE %DIF > 
\RequirePackage[normalem]{ulem} %DIF PREAMBLE %DIF > 
\RequirePackage{color}\definecolor{RED}{rgb}{1,0,0}\definecolor{BLUE}{rgb}{0,0,1} %DIF PREAMBLE %DIF > 
\providecommand{\DIFadd}[1]{{\protect\color{blue}\uwave{#1}}} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdel}[1]{{\protect\color{red}\sout{#1}}}                      %DIF PREAMBLE %DIF > 
%DIF SAFE PREAMBLE %DIF PREAMBLE %DIF > 
\providecommand{\DIFaddbegin}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFaddend}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdelbegin}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdelend}{} %DIF PREAMBLE %DIF > 
%DIF FLOATSAFE PREAMBLE %DIF PREAMBLE %DIF > 
\providecommand{\DIFaddFL}[1]{\DIFadd{#1}} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdelFL}[1]{\DIFdel{#1}} %DIF PREAMBLE %DIF > 
\providecommand{\DIFaddbeginFL}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFaddendFL}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdelbeginFL}{} %DIF PREAMBLE %DIF > 
\providecommand{\DIFdelendFL}{} %DIF PREAMBLE %DIF > 
%DIF END PREAMBLE EXTENSION ADDED BY LATEXDIFF %DIF > 
					 %DIF > 
					 %DIF > 
%DIF -------
...
% Set up some values.
%DIF 158c188
%DIF < \completetitle{Working Title: An approach to automatic and human speech recognition using ear-recorded speech.}
%DIF -------
\completetitle{An approach to automatic and human speech recognition using ear-recorded speech} %DIF > 
%DIF -------
...
\approval
{\DIFdelbegin \DIFdel{7 }\DIFdelend \DIFaddbegin \DIFadd{11 }\DIFaddend August 2017}		% Defense Date	
...
\include{./Chapter_1_Introduction/chapter_1_Introduction}
\DIFdelbegin %DIFDELCMD < \include{./Chapter_2_Data_Collection_Experiment/chapter_2_old}
%DIFDELCMD < \include{./Chapter_3_Human_Speech_Perception_Experiment/chapter_3_old}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \include{./Chapter_2_Data_Collection_Experiment/chapter_2}
\include{./Chapter_3_Human_Speech_Perception_Experiment/chapter_3}
\DIFaddend \include{./Chapter_4_ASR_Experiment/chapter_4}
\include{./Chapter_5_Discussion/chapter_5_Discussion}
