...
<<Exp_1_Data, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
<<ANOVA1_results, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
<<ANOVA2_results, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
\centering
%\textbf{Female Speech}
<<All-Factors-Female, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
par(mar=c(4,5,0,0))
...
\centering
%\textbf{Male Speech}
<<All-Factors-Male, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
par(mar=c(4,5,0,0))
...
\centering
<<line_graph_chrono_m, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
data1 <- read.csv("/home/sam/Dissertation/line_graph_combined_results_mouth.csv")
par(mar=c(5,5,1,1))
plot(data1$sent_num, data1$wer, pch = 16, cex = 1.3, col = "black", xlab = "Stimulus Presentation Order", ylab = "WER", cex.lab=1.5)
...
\centering
<<line_graph_chrono, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
\end{figure}
%
To visualize whether the performance of participants generally improves over time, scatterplots in Figures \ref{fig:linear_performance_m} and \ref{fig:linear_performance_e} graph participants' chronological performance with mouth-recorded and ear-recorded speech over the course of the experiment.  Linear regression models were fit onto the mouth-recorded data (slope=$\Sexpr{coef(mod_m)[2]}$, $R^2$=$\Sexpr{mod_m_rs}$, $p<0.001$), and the ear-recorded data (slope=$\Sexpr{coef(mod)[2]}$, $R^2$=$\Sexpr{mod_rs}$, $p>0.05$). 
...
<<F0_boxplot_noise, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
<<perc_boxplot_noise, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
<<3_experiment_data_setup, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
...
\centering
%\textbf{Female Speech}
<<boxplot_noiseXmicXall_female, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
par(mar=c(6,4,0,0))
boxplot(wer~style*mic_location*noise_type,col=c("gray88","darkseagreen1","steelblue1","gray56","darkseagreen","steelblue"),allFemaleData, names=c("Clean.E.P","Clean.H.F0","Clean.E.T","Clean.M.P","Clean.M.F0","Clean.M.T","Bus.E.P","Bus.H.F0","Bus.E.T","Bus.M.P","Bus.M.F0","Bus.M.T","Cafe.E.P","Cafe.H.F0","Cafe.E.T","Cafe.M.P","Cafe.M.F0","Cafe.M.T","Ped.E.P","Ped.H.F0","Ped.E.T","Ped.M.P","Ped.M.F0","Ped.M.T","Street.E.P","Street.H.F0","Street.E.T","Street.M.P","Street.M.F0","Street.M.T","Fact.E.P","Fact.H.F0","Fact.E.T","Fact.M.P","Fact.M.F0","Fact.M.T"),ylab="WER",las=2)
@
...
\centering
%\textbf{Male Speech}
<<boxplot_noiseXmicXall_male, echo=FALSE, message=FALSE, warning=FALSE, results='asis'>>=
par(mar=c(6,4,0,0))
boxplot(wer~style*mic_location*noise_type,col=c("gray88","darkseagreen1","steelblue1","gray56","darkseagreen","steelblue"),allMaleData, names=c("Clean.E.P","Clean.H.F0","Clean.E.T","Clean.M.P","Clean.M.F0","Clean.M.T","Bus.E.P","Bus.H.F0","Bus.E.T","Bus.M.P","Bus.M.F0","Bus.M.T","Cafe.E.P","Cafe.H.F0","Cafe.E.T","Cafe.M.P","Cafe.M.F0","Cafe.M.T","Ped.E.P","Ped.H.F0","Ped.E.T","Ped.M.P","Ped.M.F0","Ped.M.T","Street.E.P","Street.H.F0","Street.E.T","Street.M.P","Street.M.F0","Street.M.T","Fact.E.P","Fact.H.F0","Fact.E.T","Fact.M.P","Fact.M.F0","Fact.M.T"),ylab="WER",las=2)
@
