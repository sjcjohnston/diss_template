...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in ezANOVA\_main(data = data, dv = dv, wid = wid, within = within, : One or more cells is missing data. Try using ezDesign() to check your data.}}

{\ttfamily\noindent\color{warningcolor}{Warning: Collapsing data to cell means. *IF* the requested effects are a subset of the full design, you must use the "{}within\_full"{} argument, else results may be inaccurate.}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in ezANOVA\_main(data = data, dv = dv, wid = wid, within = within, : One or more cells is missing data. Try using ezDesign() to check your data.}}\end{kframe}


\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in by\_subj\_ez\_anova\$ANOVA\$ges <- NULL: object 'by\_subj\_ez\_anova' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in by\_item\_ez\_anova\$ANOVA\$ges <- NULL: object 'by\_item\_ez\_anova' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): object 'by\_subj\_ez\_anova' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): object 'by\_item\_ez\_anova' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): object 'by\_item\_ez\_anova' not found}}\end{kframe}% latex table generated in R 3.4.1 by xtable 1.8-2 package
% Wed Aug  2 14:30:16 2017
\begin{table}[ht]
\centering
