...
Voiced speech is composed of narrow bands of acoustic energy, called harmonics, 
%
...
\begin{subfigure}{0.95\textwidth}
  \centering
  \includegraphics[width=0.8\textwidth]{figure/spctgrm5k.png}
