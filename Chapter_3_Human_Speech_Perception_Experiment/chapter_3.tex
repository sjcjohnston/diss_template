...
The word error rate (WER) for each response (after obvious typographical errors were fixed) for each participant was calculated. The code for the WER calculation can be found in Appendix B\ref{appendixB}
