...
%DIF DEL Dissertation_Main_old.tex   Fri Aug  4 22:24:40 2017
%DIF ADD Dissertation_Main.tex       Fri Aug  4 22:25:51 2017
%            for use with the              %
...
% Set up some values.
%DIF 188c188
%DIF < \completetitle{An approach to automatic and human speech recognition using ear-recorded speech}
%DIF -------
...
\include{./Chapter_1_Introduction/chapter_1_diff}
\include{./Chapter_2_Data_Collection_Experiment/chapter_2_diff}
\include{./Chapter_3_Human_Speech_Perception_Experiment/chapter_3_diff}
\include{./Chapter_4_ASR_Experiment/chapter_4_diff}
\include{./Chapter_5_Discussion/chapter_5_diff}
